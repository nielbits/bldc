...
void mcpwm_foc_init(mc_configuration *conf_m1, mc_configuration *conf_m2) {
	...
	m_motor_1.p_fo_hz= 20.0f;      // = 8.0f;          // observer bandwidth (try 10–18 Hz)//100Hz //8Hz for small motor
    m_motor_1.p_gz_hz=0.2f;      // = 0.20f;           // tiny leak on z to suppress random-walk hiss (0–0.7 Hz)
    m_motor_1.p_fc_TLPF= 8s0.0f; 	  // = 200.0f;   
